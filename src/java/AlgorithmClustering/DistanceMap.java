...
public class DistanceMap {
    ...
    public Map<String, Item> getPairHash() {
        return pairHash;
    }

    public void setPairHash(Map<String, Item> pairHash) {
        this.pairHash = pairHash;
    }

    public PriorityQueue<Item> getData() {
        return data;
    }

    public void setData(PriorityQueue<Item> data) {
        this.data = data;
    }
